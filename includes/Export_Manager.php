            ...
            foreach ($export_types as $index => $type) {
                if (isset($type['name'])) {
                    ...
                    $sanitized[] = array(
                        ...
                        'excluded_payment_methods' => isset($type['excluded_payment_methods']) && is_array($type['excluded_payment_methods']) ? array_map('sanitize_text_field', $type['excluded_payment_methods']) : array(),
