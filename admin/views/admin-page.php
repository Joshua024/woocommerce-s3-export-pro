    ...
    switch ($export_type) {
        ...
        case 'order_items':
            $options = array(
                ...
                'product_variation_attributes' => 'product_variation_attributes',
                'quantity' => 'quantity',
...
function getDataSourceOptionsHTML(exportType, selectedValue = '') {
    const options = {
        'orders': [
            ...
            // Added custom/payment related fields
            'worldpay_transaction_id', 'transaction_type',
            ...
            'billing_country', 'charity_number', 'billing_title',
            ...
            'customer_note', 'source_website', 'item_id', 'item_product_id', 'item_name', 'item_sku', 'item_quantity',
...
function getDefaultFields(exportType) {
    const fields = {
        'orders': [
            ...
            { key: 'shipping_tax_total', label: 'shipping_tax_total' },
            { key: 'fee_total', label: 'fee_total' },
            { key: 'fee_tax_total', label: 'fee_tax_total' },
            { key: 'tax_total', label: 'tax_total' },
            { key: 'discount_total', label: 'discount_total' },
            { key: 'order_total', label: 'order_total' },
            { key: 'refunded_total', label: 'refunded_total' },
            { key: 'order_currency', label: 'order_currency' },
            { key: 'payment_method', label: 'payment_method' },
            { key: 'transaction_type', label: 'transaction_type' },
            { key: 'shipping_method', label: 'shipping_method' },
            { key: 'customer_id', label: 'customer_id' },
            { key: 'charity_number', label: 'charity_number' },
            { key: 'billing_title', label: 'billing_title' },
            { key: 'billing_first_name', label: 'billing_first_name' },
            { key: 'billing_last_name', label: 'billing_last_name' },
            { key: 'billing_company', label: 'billing_company' },
            { key: 'billing_email', label: 'billing_email' },
            { key: 'billing_phone', label: 'billing_phone' },
            { key: 'billing_address_1', label: 'billing_address_1' },
            { key: 'billing_address_2', label: 'billing_address_2' },
            { key: 'billing_postcode', label: 'billing_postcode' },
            { key: 'billing_city', label: 'billing_city' },
            { key: 'billing_state', label: 'billing_state' },
            { key: 'billing_country', label: 'billing_country' },
            { key: 'shipping_first_name', label: 'shipping_first_name' },
            { key: 'shipping_last_name', label: 'shipping_last_name' },
            { key: 'shipping_address_1', label: 'shipping_address_1' },
            { key: 'shipping_address_2', label: 'shipping_address_2' },
            { key: 'shipping_postcode', label: 'shipping_postcode' },
            { key: 'shipping_city', label: 'shipping_city' },
            { key: 'shipping_state', label: 'shipping_state' },
            { key: 'shipping_country', label: 'shipping_country' },
            { key: 'shipping_company', label: 'shipping_company' },
            { key: 'customer_note', label: 'customer_note' },
            { key: 'line_items', label: 'line_items' },
            { key: 'shipping_items', label: 'shipping_items' },
            { key: 'fee_items', label: 'fee_items' },
        ...
        'order_items': [
            ...
            { key: 'line_total', label: 'line_total' }
        ],
        'customers': [
            { key: 'customer_id', label: 'customer_id' },
